...
--   | |
for i = 1,7 do
    cube = gr.mesh('cube', 'LBcube'..tostring(i))
...
for i = 1,7 do
    cube = gr.mesh('cube', 'RBcube'..tostring(i))
...
--   | |
for i = 1,20 do
    cube = gr.mesh('cube', 'LLcube'..tostring(i))
...
for i = 1,20 do
    cube = gr.mesh('cube', 'RRcube'..tostring(i))
...
--   | |
for i = 1,18 do
    cube = gr.mesh('cube', 'Tcube'..tostring(i))
