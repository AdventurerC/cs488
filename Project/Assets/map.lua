...
--enemy2:scale(1.5, 0.5, 1.5)
enemy2:set_keyframe(0)
enemy2:translate(5, -0.2, 15)
enemy2:scale(0.66, 3.0, 0.66)
--enemy2:scale( 0.0, 2.0, 0.0)
enemy2:translate(-5, 1.2, -15)
--enemy2:set_material(orange)
enemy2:set_keyframe(1)
enemy2:translate(5, -1.2, 15)
--enemy2:scale(1.0, 0.5, 1.0)
enemy2:scale(1.0, 0.66, 1.0)
enemy2:translate(-5, 1.7, -15)
enemy2:set_keyframe(2)
enemy2:translate(5, -1.7, 15)
--enemy2:scale(1.0, 2.0, 1.0)
--enemy2:scale(0.67, 2.0, 0.67)
enemy2:translate(-5, 1.2, -15)
enemy2:set_keyframe(3)
enemy2:translate(5, -1.2, 15)
enemy2:scale(1.5, 0.25, 1.5)
enemy2:translate(-5, 0.0, -15)
enemy2:set_keyframe(4)
...
--bg:scale(40, 1.0, 20)
--bg:rotate('x', 90)
--bg:translate(0.0, -0.5, -50)
--bg:set_material(white)
--bg:set_texture(gr.texture("Assets/cat.jpg"))
